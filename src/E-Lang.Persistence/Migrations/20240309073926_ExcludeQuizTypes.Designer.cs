...
namespace E_Lang.Persistence.Migrations
{
    ...
    [Migration("20240309073926_ExcludeQuizTypes")]
    partial class ExcludeQuizTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Lang.Domain.Entities.ExcludedQuizType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("E_Lang.Domain.Entities.AttemptQuizType", b =>
                {
                    b.HasOne("E_Lang.Domain.Entities.Attempt", null)
                        .WithMany("AttemptQuizTypes")
                        .HasForeignKey("AttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Lang.Domain.Entities.QuizType", "QuizType")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Lang.Domain.Entities.Attempt", b =>
                {
                    b.Navigation("AttemptQuizTypes");

                    b.Navigation("AttemptStages");
                });
            ...
            modelBuilder.Entity("E_Lang.Domain.Entities.InProgressFlashcardState", b =>
                {
                    ...
                    b.Navigation("ExcludedQuizTypes");
